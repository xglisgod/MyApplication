...
public class WordsDBHelper extends SQLiteOpenHelper{
    ...
    private final static String SQL_CREATE_DATABASE =" CREATE TABLE "+Words.Word.TABLE_NAME+" ( "+Words.Word.ID+ " INTEGER  PRIMARY KEY AUTOINCREMENT, " +Words.Word.CONTENT

            +" TEXT NOT NULL, "+Words.Word.TIME+" TEXT NOT NULL )";
